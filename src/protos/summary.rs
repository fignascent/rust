...
impl SummaryMetadata {
    ...
    pub fn get_data_class(&self) -> DataClass {
        self.data_class
    }
    pub fn clear_data_class(&mut self) {
        self.data_class = DataClass::DATA_CLASS_UNKNOWN;
    }

    // Param is passed by value, moved
    pub fn set_data_class(&mut self, v: DataClass) {
        self.data_class = v;
    }
}
...
impl ::protobuf::Message for SummaryMetadata {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                4 => {
                    ::protobuf::rt::read_proto3_enum_with_unknown_fields_into(wire_type, is, &mut self.data_class, 4, &mut self.unknown_fields)?
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.data_class != DataClass::DATA_CLASS_UNKNOWN {
            my_size += ::protobuf::rt::enum_size(4, self.data_class);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.data_class != DataClass::DATA_CLASS_UNKNOWN {
            os.write_enum(4, ::protobuf::ProtobufEnum::value(&self.data_class))?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeEnum<DataClass>>(
                "data_class",
                |m: &SummaryMetadata| { &m.data_class },
                |m: &mut SummaryMetadata| { &mut m.data_class },
            ));
...
impl ::protobuf::ProtobufEnum for DataClass {
    fn value(&self) -> i32 {
        *self as i32
    }

    fn from_i32(value: i32) -> ::std::option::Option<DataClass> {
        match value {
            0 => ::std::option::Option::Some(DataClass::DATA_CLASS_UNKNOWN),
            1 => ::std::option::Option::Some(DataClass::DATA_CLASS_SCALAR),
            2 => ::std::option::Option::Some(DataClass::DATA_CLASS_TENSOR),
            3 => ::std::option::Option::Some(DataClass::DATA_CLASS_BLOB_SEQUENCE),
            _ => ::std::option::Option::None
        }
    }

    fn values() -> &'static [Self] {
        static values: &'static [DataClass] = &[
            DataClass::DATA_CLASS_UNKNOWN,
            DataClass::DATA_CLASS_SCALAR,
            DataClass::DATA_CLASS_TENSOR,
            DataClass::DATA_CLASS_BLOB_SEQUENCE,
        ];
        values
    }
    ...
    fn enum_descriptor_static() -> &'static ::protobuf::reflect::EnumDescriptor {
        ...
        descriptor.get(|| {
            ::protobuf::reflect::EnumDescriptor::new_pb_name::<DataClass>("DataClass", file_descriptor_proto())
        })
    }
}

impl ::std::marker::Copy for DataClass {
}

impl ::std::default::Default for DataClass {
    fn default() -> Self {
        DataClass::DATA_CLASS_UNKNOWN
    }
}

impl ::protobuf::reflect::ProtobufValue for DataClass {
    fn as_ref(&self) -> ::protobuf::reflect::ReflectValueRef {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x06bucketB\x02\x10\x01\"\xad\x02\n\x0fSummaryMetadata\x12G\n\x0bplugin_\
    data\x18\x01\x20\x01(\x0b2&.tensorflow.SummaryMetadata.PluginDataR\nplug\
    inData\x12!\n\x0cdisplay_name\x18\x02\x20\x01(\tR\x0bdisplayName\x12/\n\
    \x13summary_description\x18\x03\x20\x01(\tR\x12summaryDescription\x124\n\
    \ndata_class\x18\x04\x20\x01(\x0e2\x15.tensorflow.DataClassR\tdataClass\
    \x1aG\n\nPluginData\x12\x1f\n\x0bplugin_name\x18\x01\x20\x01(\tR\nplugin\
    Name\x12\x18\n\x07content\x18\x02\x20\x01(\x0cR\x07content\"\xbc\x06\n\
    \x07Summary\x12/\n\x05value\x18\x01\x20\x03(\x0b2\x19.tensorflow.Summary\
    .ValueR\x05value\x1a\x87\x01\n\x05Image\x12\x16\n\x06height\x18\x01\x20\
    \x01(\x05R\x06height\x12\x14\n\x05width\x18\x02\x20\x01(\x05R\x05width\
    \x12\x1e\n\ncolorspace\x18\x03\x20\x01(\x05R\ncolorspace\x120\n\x14encod\
    ed_image_string\x18\x04\x20\x01(\x0cR\x12encodedImageString\x1a\xc5\x01\
    \n\x05Audio\x12\x1f\n\x0bsample_rate\x18\x01\x20\x01(\x02R\nsampleRate\
    \x12!\n\x0cnum_channels\x18\x02\x20\x01(\x03R\x0bnumChannels\x12#\n\rlen\
    gth_frames\x18\x03\x20\x01(\x03R\x0clengthFrames\x120\n\x14encoded_audio\
    _string\x18\x04\x20\x01(\x0cR\x12encodedAudioString\x12!\n\x0ccontent_ty\
    pe\x18\x05\x20\x01(\tR\x0bcontentType\x1a\xad\x03\n\x05Value\x12\x1b\n\t\
    node_name\x18\x07\x20\x01(\tR\x08nodeName\x12\x10\n\x03tag\x18\x01\x20\
    \x01(\tR\x03tag\x127\n\x08metadata\x18\t\x20\x01(\x0b2\x1b.tensorflow.Su\
    mmaryMetadataR\x08metadata\x12#\n\x0csimple_value\x18\x02\x20\x01(\x02H\
    \0R\x0bsimpleValue\x12A\n\x1cobsolete_old_style_histogram\x18\x03\x20\
    \x01(\x0cH\0R\x19obsoleteOldStyleHistogram\x121\n\x05image\x18\x04\x20\
    \x01(\x0b2\x19.tensorflow.Summary.ImageH\0R\x05image\x122\n\x05histo\x18\
    \x05\x20\x01(\x0b2\x1a.tensorflow.HistogramProtoH\0R\x05histo\x121\n\x05\
    audio\x18\x06\x20\x01(\x0b2\x19.tensorflow.Summary.AudioH\0R\x05audio\
    \x121\n\x06tensor\x18\x08\x20\x01(\x0b2\x17.tensorflow.TensorProtoH\0R\
    \x06tensorB\x07\n\x05value*o\n\tDataClass\x12\x16\n\x12DATA_CLASS_UNKNOW\
    N\x10\0\x12\x15\n\x11DATA_CLASS_SCALAR\x10\x01\x12\x15\n\x11DATA_CLASS_T\
    ENSOR\x10\x02\x12\x1c\n\x18DATA_CLASS_BLOB_SEQUENCE\x10\x03B~\n\x18org.t\
    ensorflow.frameworkB\rSummaryProtosP\x01ZNgithub.com/tensorflow/tensorfl\
    ow/tensorflow/go/core/framework/summary_go_proto\xf8\x01\x01b\x06proto3\
";
