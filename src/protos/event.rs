...
impl<'a> ::std::default::Default for &'a RequestedExitCode {
    fn default() -> &'a RequestedExitCode {
        <RequestedExitCode as ::protobuf::Message>::default_instance()
    }
}

impl RequestedExitCode {
    pub fn new() -> RequestedExitCode {
        ::std::default::Default::default()
    }
...
impl ::protobuf::Message for RequestedExitCode {
    fn is_initialized(&self) -> bool {
        true
    }
    ...
    fn new() -> RequestedExitCode {
        RequestedExitCode::new()
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeInt32>(
                "exit_code",
                |m: &RequestedExitCode| { &m.exit_code },
                |m: &mut RequestedExitCode| { &mut m.exit_code },
            ));
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<RequestedExitCode>(
                "RequestedExitCode",
                fields,
                file_descriptor_proto()
            )
    ...
    fn default_instance() -> &'static RequestedExitCode {
        static instance: ::protobuf::rt::LazyV2<RequestedExitCode> = ::protobuf::rt::LazyV2::INIT;
        instance.get(RequestedExitCode::new)
    }
}

impl ::protobuf::Clear for RequestedExitCode {
    fn clear(&mut self) {
        self.exit_code = 0;
        self.unknown_fields.clear();
    }
...
impl ::std::fmt::Debug for RequestedExitCode {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for RequestedExitCode {
    fn as_ref(&self) -> ::protobuf::reflect::ReflectValueRef {
        ::protobuf::reflect::ReflectValueRef::Message(self)
    }
}
...
pub struct WorkerHeartbeatRequest {
    ...
    pub exit_code: ::protobuf::SingularPtrField<RequestedExitCode>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl WorkerHeartbeatRequest {
    ...
    pub fn get_exit_code(&self) -> &RequestedExitCode {
        self.exit_code.as_ref().unwrap_or_else(|| <RequestedExitCode as ::protobuf::Message>::default_instance())
    }
    pub fn clear_exit_code(&mut self) {
    ...
    // Param is passed by value, moved
    pub fn set_exit_code(&mut self, v: RequestedExitCode) {
        self.exit_code = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_exit_code(&mut self) -> &mut RequestedExitCode {
        if self.exit_code.is_none() {
            self.exit_code.set_default();
        }
        self.exit_code.as_mut().unwrap()
    }

    // Take field
    pub fn take_exit_code(&mut self) -> RequestedExitCode {
        self.exit_code.take().unwrap_or_else(|| RequestedExitCode::new())
    }
}
...
impl ::protobuf::Message for WorkerHeartbeatRequest {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                3 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.exit_code)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let Some(ref v) = self.exit_code.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<RequestedExitCode>>(
                "exit_code",
                |m: &WorkerHeartbeatRequest| { &m.exit_code },
                |m: &mut WorkerHeartbeatRequest| { &mut m.exit_code },
            ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x20\x01(\x03R\ttimeoutMs\"0\n\x11RequestedExitCode\x12\x1b\n\texit_code\
    \x18\x01\x20\x01(\x05R\x08exitCode\"\xde\x01\n\x16WorkerHeartbeatRequest\
    \x12C\n\rshutdown_mode\x18\x01\x20\x01(\x0e2\x1e.tensorflow.WorkerShutdo\
    wnModeR\x0cshutdownMode\x12C\n\x0fwatchdog_config\x18\x02\x20\x01(\x0b2\
    \x1a.tensorflow.WatchdogConfigR\x0ewatchdogConfig\x12:\n\texit_code\x18\
    \x03\x20\x01(\x0b2\x1d.tensorflow.RequestedExitCodeR\x08exitCode\"\xa6\
    \x01\n\x17WorkerHeartbeatResponse\x12=\n\rhealth_status\x18\x01\x20\x01(\
    \x0e2\x18.tensorflow.WorkerHealthR\x0chealthStatus\x120\n\nworker_log\
    \x18\x02\x20\x03(\x0b2\x11.tensorflow.EventR\tworkerLog\x12\x1a\n\x08hos\
    tname\x18\x03\x20\x01(\tR\x08hostname*[\n\x0cWorkerHealth\x12\x06\n\x02O\
    K\x10\0\x12\x1c\n\x18RECEIVED_SHUTDOWN_SIGNAL\x10\x01\x12\x12\n\x0eINTER\
    NAL_ERROR\x10\x02\x12\x11\n\rSHUTTING_DOWN\x10\x03*k\n\x12WorkerShutdown\
    Mode\x12\x0b\n\x07DEFAULT\x10\0\x12\x12\n\x0eNOT_CONFIGURED\x10\x01\x12\
    \x18\n\x14WAIT_FOR_COORDINATOR\x10\x02\x12\x1a\n\x16SHUTDOWN_AFTER_TIMEO\
    UT\x10\x03B'\n\x13org.tensorflow.utilB\x0bEventProtosP\x01\xf8\x01\x01b\
    \x06proto3\
";
